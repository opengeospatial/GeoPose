...
|===
<|*Requirements Class:* <|*Basic-Quaternion* 

<s|ID |<<req_basic_quaternion_sdu,/req/basic/quaternion/sdu>>
<s|Target Type|Implemntation of Logical Model
...
<s|Requirement B-TP-Lat-SDU|/req/tangent_plane/latitude/sdu 
<s|Requirement B-TP-h-SDU|req/tangent_plane/h/sdu 
<s|Requirement B-Quaternion-SDU|/req/orientation/quaternion/sdu 
...
<s|ID |<<req_sdu_pose_geopose_instant,/req/pose/geopose_instant/sdu>>
...
<s|ID |<<req_sdu_frame_specification_authority,/req/framespecification/authority/sdu>>
2+<|The FrameSpecification.authority attribute SHALL contain a string uniquely specifying a source of reference frame specifications.
|===
...
2+<|The FrameSpecification.ID attribute SHALL be a string uniquely defining a frame within the authority.
|===
...
2+<|The FrameSpecification.parameter attribute SHALL contain all parameters needed for the corresponding authority and ID.
|===
...
[width="100%",cols="4,6"]
|===
<s|*Requirement GP-Instant-SDU* |*/req/pose/geoposeinstant/sdu* 
<s|Requirement |The Logical Model attribute GeoPoseInstant SHALL be expressed in Unix Time in seconds multiplied by 1,000. The unit of measure SHALL be milliseconds.
<s|ID |<<req_sdu_pose_geoposeinstant,/req/pose/geoposeinstant/sdu>>
|===
...
<s|Requirement |The FrameSpecification.authority attribute SHALL contain a string uniquely specifying a source of reference frame specifications.
<s|ID |<<req_sdu_frame_specification_authority,/req/framespecification/authority/sdu>>
|===
...
<s|Requirement |The FrameSpecification.ID attribute SHALL be a string uniquely defining a frame within the authority.
<s|ID |<<req_sdu_frame_specification_id,/req/frame_specification/id/sdu>>
|===
...
<s|Requirement |The FrameSpecification.parameter attribute SHALL contain all parameters needed for the corresponding authority and ID.
<s|ID |<<req_sdu_frame_specification_parameter,/req/frame_specification/parameters/sdu>>
|===

[width="100%",cols="4,6"]
|===
<s|*Requirement GP-Index-SDU* |*/req/Chain/index/SDU* 
<s|Requirement |Each index vaue in a FrameListTransformPair SHALL be a distinct integer value between 0 and one less than the number of elements in the frameList property.
<s|ID |<<req_Chain/structure,/req/Chain/index/SDU>>
|===
...
[width="100%",cols="4,6"]
|===
<s|*Requirement S-Header-SDU* |*/req/RegularSeries/header/SDU* 
<s|Requirement |A header property SHALL be implemented as a SeriesHeader.
<s|ID |<<req_Chain/structure,/req/RegularSeries/header/SDU>>
|===

[width="100%",cols="4,6"]
|===
<s|*Requirement GP-Duration-SDU* |*/req/RegularSeries/duration/SDU* 
<s|Requirement |An interposeDuration property SHALL be implemented as a GeoPoseDuration.
<s|ID |<<req_Chain/structure,/req/RegularSeries/duration/SDU>>
|===
...
[width="100%",cols="4,6"]
|===
<s|*Requirement S-Trailer-SDU* |*/req/RegularSeries/trailer/SDU* 
<s|Requirement |A trailer property SHALL be implemented as a SeriesTrailer.
<s|ID |<<req_Chain/structure,/req/RegularSeries/trailer/SDU>>
|===
...
[width="100%",cols="4,6"]
|===
<s|*Requirement S-FT-Element-SDU* |*/req/IrregularSeries/frameandtime/SDU* 
...
[width="100%",cols="4,6"]
|===
<s|*Requirement S-TM-SDU* |*/req/Stream/sdu* 
<s|Requirement |A TransitionModel property SHALL be implemented as one of the values in the TransitionModel enumeration.
<s|ID |<<req_Stream/structure,/req/Stream/sdu>>
|===
