...
^|Requirement |An implementation of an Advanced Target conform to Requirements AD-S-1, GP-Instant-SDU, and Q-SDU.
...
[width="100%",cols="4,6"]
|===
^|*Requirement Graph-SDU* |*/req/Graph/sdu* 
^|Requirement |An implementation of a Graph GeoPose shall conform to Requirements GP=Instant-SDU, GP-FrameSpec-SDU, and GP=FTIndexPair-SDU.
^|ID |<<req_Graph/structure,/req/Graph/sdu>>
|===
...
include::requirements/sdu/Req_SDU_FrameTransformIndexPair.adoc[]
...
^|Requirement |An implementation of a Chain GeoPose shall conform to Requirements GP-Instant-SDU and GP-FramwSpec-SDU.
...
^|Requirement |An implementation of a Regular Series GeoPose shall conform to Requirements S-Header-SDU, GP-Duration-SDU, GP-FS-SDU, S-Trailer-SDU.
...
^|Requirement |An implementation of an Irregular Series GeoPose shall conform to Requirements S-Header-SDU, GP-FS-SDU, S-FT-Element-SDU, and S-Trailer-SDU. 
...
^|Requirement |An implementation of a Stream GeoPose shall conform to Requirements S-TM-SDU, GP-FS-SDU, and S-FT-Element-SDU.
