...
include::req/basic_ypr/sdu_class.adoc[]

Details of the individual requirements are listed below:

include::req/basic_ypr/sdu.adoc[]

include::req/tangent_plane_longitude/sdu.adoc[]

include::req/tangent_plane_latitude/sdu.adoc[]

include::req/tangent_plane_h/sdu.adoc[]

include::req/orientation_ypr_angles/sdu.adoc[]
...
include::req/basic_quaternion/sdu.adoc[]

Details of the individual requirements are listed below:

include::req/orientation_quaternion/sdu.adoc[]
...
include::req/advanced/sdu.adoc[]

include::req/time/geopose_instant/sdu.adoc[]

include::req/frame_specification/authority/sdu.adoc[]

include::req/frame_specification/id/sdu.adoc[]

include::req/frame_specification/parameters/sdu.adoc[]
...
include::req/chain/transform_index/sdu.adoc[]
...
include::req/regular_series/sdu.adoc[]

include::req/regular_series/header/sdu.adoc[]

include::req/time/geopose_duration/sdu.adoc[]
...
include::req/series/regular/trailer/sdu.adoc[]
...
include::req/irregular_series/sdu.adoc[]

include::req/irregular_series_header/sdu.adoc[]

include::req/frame_specification_authority/sdu.adoc[]

include::req/frame_specification_id/sdu.adoc[]

include::req/frame_specification_parameters/sdu.adoc[]

include::req/irregular_series_frame_and_time/sdu.adoc[]

include::req/regular_series_trailer/sdu.adoc[]
...
include::req/stream/sdu.adoc[]

include::req/transition_model/sdu.adoc[]
...
include::req/stream/frame_time_element/sdu.adoc[]
...
include::req/series/regular/encoding/json.adoc[]
...
include::req/series/irregular/encoding/json.adoc[]
