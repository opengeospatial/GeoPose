...
''''
[[requirements]]
== Requirements for Structural Data Units and Standardization Targets
...
^|Requirement |There SHALL be no dependency between or among the individual Targets.
...
[width="100%",cols="4,6"]
|===
^|*Requirement G-SDU* |*/req/sdu_general* 
^|Requirement |Implementations using encoded SDUs SHALL conform to the logical description of the model elements with the "Structural Data Unit - SDU" stereotype. 
^|ID |<<req_sdu_general,/req/sdu_general>>
|===
...
[width="100%",cols="4,6"]
|===
^|*Requirement G-LM* |*/req/lm_general* 
^|Requirement |Implementations of concrete data conforming to this standard SHALL conform to all dependent or inherited classes, attributes, and associations, multiplicities, and data types in the Logical Model.
^|ID |<<req_lm_general,/req/lm_general>>
|===
