...
include::req/global/target-dependency.adoc[]

include::req/global/sdu-general.adoc[]

include::req/global/lm-general.adoc[]
...
include::req/basic-ypr.adoc[]

Details of the individual requirements are listed below:

include::req/basic-ypr/sdu.adoc[]

include::req/basic-ypr/sdu-tangent-plane-longitude.adoc[]

include::req/basic-ypr/sdu-tangent-plane-latitude.adoc[]

include::req/basic-ypr/sdu-tangent-plane-h.adoc[]

include::req/basic-ypr/sdu-orientation-ypr-angles.adoc[]
...
include::req/basic-quaternion.adoc[]

Details of the individual requirements are listed below:

include::req/basic-quaternion/sdu-tangent-plane-longitude.adoc[]

include::req/basic-quaternion/sdu-tangent-plane-latitude.adoc[]

include::req/basic-quaternion/sdu-tangent-plane-h.adoc[]

include::req/basic-quaternion/sdu-orientation_quaternion.adoc[]
...
include::req/advanced/sdu-time-geopose-instant.adoc[]

include::req/advanced/sdu-frame-specification-authority.adoc[]

include::req/advanced/sdu-frame-specification-id.adoc[]

include::req/advanced/sdu-frame-specification-parameters.adoc[]

include::req/advanced/sdu-orientation-quaternion.adoc[]
...
include::req/graph/sdu-time-geopose-instant.adoc[]

include::req/graph/sdu-frame-specification-authority.adoc[]

include::req/graph/sdu-frame-specification-id.adoc[]

include::req/graph/sdu-frame-specification-parameters.adoc[]

include::req/graph/sdu-graph-transform-index.adoc[]

// Requirement not existent
// include::req/graph/index.adoc[]
...
include::req/chain/sdu-time-geopose-instant.adoc[]

include::req/chain/sdu-frame-specification-authority.adoc[]

include::req/chain/sdu-frame-specification-id.adoc[]

include::req/chain/sdu-frame-specification-parameters.adoc[]
...
include::req/regular-series.adoc[]

include::req/regular-series/sdu-header.adoc[]

include::req/regular-series/sdu-time/geopose-duration.adoc[]

include::req/regular-series/sdu-frame-specification-authority.adoc[]

include::req/regular-series/sdu-frame-specification-id.adoc[]

include::req/regular-series/sdu-frame-specification-parameters.adoc[]

include::req/regular-series/sdu-series-regular-trailer.adoc[]
...
include::req/irregular-series.adoc[]

include::req/irregular-series/sdu-header.adoc[]

include::req/irregular-series/sdu-frame-specification-authority.adoc[]

include::req/irregular-series/sdu-frame-specification-id.adoc[]

include::req/irregular-series/sdu-frame-specification-parameters.adoc[]

include::req/irregular-series/sdu-irregular-series-frame-and-time.adoc[]

include::req/irregular-series/sdu-regular-series-trailer.adoc[]
...
include::req/stream/sdu-transition-model.adoc[]

include::req/stream/sdu-frame-specification-authority.adoc[]

include::req/stream/sdu-frame-specification-id.adoc[]

include::req/stream/sdu-frame-specification-parameters.adoc[]

include::req/stream/sdu-stream-frame-time-element.adoc[]
...
include::req/basic-ypr-encoding-json/definition.adoc[]
...
include::req/basic-quaternion-encoding-json-strict/definition.adoc[]
...
include::req/basic-quaternion-encoding-json/definition.adoc[]
...
include::req/advanced-encoding-json/definition.adoc[]
...
include::req/graph-encoding-json/definition.adoc[]
...
include::req/chain-encoding-json/definition.adoc[]
...
include::req/series-regular-encoding-json/definition.adoc[]
...
include::req/series-irregular-encoding-json/definition.adoc[]
...
include::req/stream-encoding-json/header.adoc[]
...
include::req/stream-encoding-json/element.adoc[]
