...
[width="100%",cols="4,6"]
|===
^|*Requirement BE-S-{counter:req-be-sdu-id}* |*/req/basic/ypr/sdu* 
...
[width="100%",cols="3,6"]
|===
^|*Requirement BE-S-{counter:req-be-id}* |*/req/basic/quaternion/structure* 
...
^|ID |<<req_basic_ypr,/req/basic/quaternion/structure>>
|===
