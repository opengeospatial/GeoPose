...
include::conf/basic_ypr/sdu/target.adoc[]
...
include::conf/basic_quaternion/sdu/target.adoc[]

==== Advanced SDU Conformance Class

include::conf/advanced.adoc[]

include::conf/geopose_instant.adoc[]
...
include::conf/geopose_duration.adoc[]
