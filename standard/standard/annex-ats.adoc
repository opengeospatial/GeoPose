...
subject:: req_class_basic_ypr_sdu
classification:: Target Type:SDU
...
subject:: req_basic_quaternion_sdu
classification:: Target Type:SDU
...
subject:: req_regular_series_sdu
classification:: Target Type:SDU
...
subject:: req_irregular_series_sdu
classification:: Target Type:SDU
