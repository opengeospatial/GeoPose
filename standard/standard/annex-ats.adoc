...
====
[%metadata]
label:: /conf/basic_quaternion_sdu
requirement:: /req/basic_quaternion_sdu
classification:: Target Type:SDU
...
inherit:: /req/basic_quaternion/sdu
test-method:: Inspection
====
...
requirement:: /req/series_trailer/sdu
test-method:: Inspection
====
...
requirement:: /req/series_frame_and_time/sdu
test-method:: Inspection
====
