...
include::conf/graph/sdu-graph-index.adoc[]
...
include::conf/irregular-series/sdu-regular-series-trailer.adoc[]
...
include::conf/basic-ypr-encoding-json.adoc[]

include::conf/basic-ypr-encoding-json/definition.adoc[]
...
include::conf/advanced-encoding-json/definition.adoc[]
...
include::conf/series-regular-encoding-json.adoc[]

include::conf/series-regular-encoding-json/definition.adoc[]

The *GeoPose Irregular Series* JSON encoding has an optional time stamp and a flexible Outer Frame specification.

include::conf/series-irregular-encoding-json.adoc[]

include::conf/series-irregular-encoding-json/definition.adoc[]
...
EDITOR
====
There was one test before: /conf/stream/encoding/json/test

But then, these were added according to OGC instructions: /req/stream-encoding-json/header,
/req/stream-encoding-json/element and /req/stream/report/encoding/json.

Nevertheless, their content may not be correct, please check.
====

include::conf/stream-encoding-json/header.adoc[]

include::conf/stream-encoding-json/element.adoc[]

include::conf/stream-encoding-json/record.adoc[]
